...
const Breadcrumb: React.FC<BreadcrumbProps> = ({ title }) => (
    <div style={{
        background: 'linear-gradient(135deg, #e0f7f7 0%, #b2ebf2 50%, #e8f5e9 100%)',
        padding: '60px 20px',
        textAlign: 'center',
    }}>
        <h1 style={{
...
const blogs: BlogType[] = [
    {
        ...
        image: 'https://images.unsplash.com/photo-1514995669114-6081e934b693?w=400&q=80',
    },
    {
        id: 2,
...
const categories = ['WEIGHT LOSS', 'NUTRITION', 'FITNESS', 'RECIPES', 'WELLNESS']
...
/* ── Page ── */
const Page: React.FC = () => {
    const [selectedCategories, setSelectedCategories] = useState<string[]>(['WEIGHT LOSS'])
                ...
                <div style={{
                        ...
                        <div style={{
                            ...
                            {categories.map(cat => (
                                <label key={cat} style={{
                                    ...
                                    cursor: 'pointer',
                                    fontSize: '0.88rem',
                                    color: selectedCategories.includes(cat) ? '#00897b' : '#636e72',
                    ...
                    <div style={{ flex: 1 }}>
                        <div style={{
                            ...
                            {filtered.length === 0 && (
                                <p style={{ color: '#b2bec3', fontSize: '1rem' }}>No blogs found for selected categories.</p>
                            )}
                        </div>
