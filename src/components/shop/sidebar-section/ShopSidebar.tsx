...
function ShopSidebar({
    ...
    const [show, setShow] = useState<ShowType>({categories:false, brands: false});
                                        ...
                                        <Fade triggerOnce direction='up' duration={1000} delay={200}>
                                            <div className="bb-sidebar-block-item">
                                                <input
                                                    ...
                                                    checked={selectedCategory?.includes(data.name)}
                                                    type="checkbox"
                                                />
                                        ...
                                        <Fade triggerOnce direction='up' duration={1000} delay={200}>
                                            <div className="bb-sidebar-block-item">
                                                <input
                                                    ...
                                                    type="checkbox"
                                                />
                                                <a onClick={(e) => e.preventDefault()} href="#">{data.name}</a>
                                                <span className="checked"></span>
                                            </div>
                                        </Fade>
                                    </li>
