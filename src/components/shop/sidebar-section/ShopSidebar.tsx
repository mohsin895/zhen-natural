...
function ShopSidebar({
                         ...
                         selectedCategory,
                         handleBrandChange,
                         selectedBrandIds,   // string[] of brand ids from URL e.g. ["1","3"]
                         handlePriceChange,
                         min,
                         max,
                         categories,
            ...
            <div className="bb-shop-wrap">
                ...
                <div className="bb-sidebar-block">
                    ...
                    <div className="bb-sidebar-contact">
                        <ul>
                            ...
                            {!categoriesLoading && categories && categories.length > limit && (
                                <li>
                ...
                <div className="bb-sidebar-block">
                    ...
                    <div className="bb-sidebar-contact">
                        <ul>
                            {brandsLoading ? (
                                <li><span>Loading brands...</span></li>
                            ) : BrandData.length === 0 ? (
                                <li><span>No brands found</span></li>
                            ) : (
                                    ...
                                    <li key={data.id || index}>
                                        <Fade triggerOnce direction="up" duration={1000} delay={200}>
                                            <div className="bb-sidebar-block-item">
                                                <input
                                                    type="checkbox"
                                                    // FIX: pass brand id (not name) — handleBrandChange updates
                                                    // the URL (?brands=1,2,3) which triggers a real API fetch.
                                                    onChange={() => handleBrandChange(data.id)}
                                                    // FIX: check against selectedBrandIds (string[] from URL)
                                                    checked={
                                                        Array.isArray(selectedBrandIds) &&
                                                        selectedBrandIds.includes(String(data.id))
                                                    }
                                                />
                ...
                {showButton && (
                    ...
                    >
                        <button onClick={handleFilterBtn} type="button" className="bb-btn-2">
                            Filter
                        </button>
                    </div>
                )}
