...
const DOMAIN =
  process.env.NEXT_PUBLIC_DOMAIN || "https://admin.zhennatural.com/api/v2";
...
const TrackOrders = () => {
  ...
  const handleTrack = async () => {
    ...
    try {
      ...
      const status =
        data.order?.orderStatus?.name?.toLowerCase?.().replace(/\s+/g, "_") ||
        "";
    ...
    <div style={styles.page as React.CSSProperties}>
      ...
      <div style={styles.container as React.CSSProperties}>
        ...
        <div style={styles.header as React.CSSProperties}>
          <span style={styles.eyebrow as React.CSSProperties}>
            Zhen Natural
          </span>
              ...
              <div style={styles.orderInfoGrid as React.CSSProperties}>
                {orderData.code && (
                  <div>
                    ...
                    <span style={styles.infoVal as React.CSSProperties}>
                      {orderData.code}
                    </span>
                  </div>
                )}
          ...
          <div style={styles.stepperOuter as React.CSSProperties}>
            ...
            {steps.map((step) => {
              ...
              return (
                <div
                  key={step.id}
                  style={styles.stepItem as React.CSSProperties}
                >
                  <div
                    style={
                      {
                  ...
                  >
                    <span style={styles.stepIcon as React.CSSProperties}>
                      {step.icon}
                    </span>
                  </div>
                  <span
